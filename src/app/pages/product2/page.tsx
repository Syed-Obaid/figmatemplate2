...
function HappyProduct() {
  return (
    <>
      <section className='mt-4 pt-4 '>
        <div className='max-w-[1200px] mx-auto items-center justify-center h-auto'>
<h1 style={{fontFamily:"Playfair Display"}} className='text-6xl uppercase  max-w-6xl'>Best outfit for your happiness </h1>
        </div>
      </section>
...
<div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4   gap-2 mx-auto'>
    <div className='shadow-lg  max-w-md mx-auto'>
        ...
        <img className='w-auto h-auto duration-1000 hover:scale-125' src="/product5.png" alt="" />
    ...
    <div className='shadow-lg  max-w-md mx-auto'>
        <div className='overflow-hidden'>
        <img className='w-auto h-auto duration-1000 hover:scale-125' src="/product6.png" alt="" />
        </div>
        <p style={{fontFamily:"lato"}} className='uppercase text-[13px] mt-2 pt-3 text-gray-500'>Product Category</p>
        <h2 style={{fontFamily:"Playfair Display"}}  className='text-3xl py-2'>Product Name</h2>
        <p className='text-[16px] text-gray-500'>IDR XXX</p>
    ...
    <div className='shadow-lg  max-w-md mx-auto'>
        <div className='overflow-hidden'>
        <img className='w-auto h-auto duration-1000 hover:scale-125' src="/product7.png" alt="" />
        </div>
        <p style={{fontFamily:"lato"}} className='uppercase text-[13px] mt-2 pt-3 text-gray-500'>Product Category</p>
        <h2 style={{fontFamily:"Playfair Display"}}  className='text-3xl py-2'>Product Name</h2>
        <p className='text-[16px] text-gray-500'>IDR XXX</p>
    ...
    <div className='shadow-lg  max-w-md mx-auto'>
        <div className='overflow-hidden'>
        <img className='w-auto h-auto duration-1000 hover:scale-125' src="/product8.png" alt="" />
        </div>
        <p style={{fontFamily:"lato"}} className='uppercase text-[13px] mt-2 pt-3 text-gray-500'>Product Category</p>
        <h2 style={{fontFamily:"Playfair Display"}}  className='text-3xl py-2'>Product Name</h2>
        <p className='text-[16px] text-gray-500'>IDR XXX</p>
